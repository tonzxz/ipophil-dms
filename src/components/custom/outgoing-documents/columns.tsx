...
export const columns: ColumnDef<Document>[] = [
    ...
    // },
    {
        accessorKey: 'to_agency',
        header: ({ column }) => (
            <DataTableColumnHeader column={column} title='Receiving Office' />
        ),
        cell: ({ row }) => {
            const toOffice = row.getValue('to_agency') as string
            return <span title={`Receiving Office: ${toOffice}`}>{toOffice}</span>
        },
    },
    {
        accessorKey: 'title',
